    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">Detail Tarif Kendaraan </h2>
          ...
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Tarif Kendaraan</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="card-body">
              <form action="<?=base_url('tarif/simpan')?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input required name="tipe_kendaraan" id="inputText3" type="text" class="form-control" value="<?= $data->tipe_kendaraan ?>">
                </div>
                <div class="form-group">
                  <label for="inputText3" class="col-form-label">Nama Merk Kendaraan</label>
                  <input required name="merk_kendaraan" id="inputText3" type="text" class="form-control" value="<?= $data->merk_kendaraan ?>">
                </div>
                <div class="form-group">
                  <label for="inputText3" class="col-form-label">Tarif Kendaraan</label>
                  <input required name="tarif_kendaraan" id="tarif_kendaraan" type="text" class="uang form-control" value="<?= $data->tarif_kendaraan ?>">
                </div>

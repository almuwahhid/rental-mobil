        ...
        <div class="page-header">
          ...
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Model Kendaraan</a></li>
                <li class="breadcrumb-item active" aria-current="page">Tambah Model Kendaraan</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="card-body">
              <form action="<?=base_url('modelkendaraan/simpan')?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input required name="model" id="inputText3" type="text" class="form-control">
                </div>
